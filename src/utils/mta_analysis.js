...
function getMainInfo() {
  var a = { dm: "wechat.apps.xx", url: getPagePath(), pvi: "", si: "", ty: 0 };
  a.pvi = (function() {
    var b = getUID();
    b || ((b = setUID()), (a.ty = 1));
    return b;
    ...
    stat: function(a) {
      if ("" != MTA_CONFIG.app_id) {
        ...
        if (MTA.Data.lanchInfo) {
          ...
          MTA.Data.lanchInfo.query &&
            MTA.Data.lanchInfo.query._mta_ref_id &&
            a.push({ rarg: MTA.Data.lanchInfo.query._mta_ref_id });
          try {
            1 == MTA.Data.lanchInfo.landing &&
              ((c.ext += ";lp=1"), (MTA.Data.lanchInfo.landing = 0));
          } catch (e) {}
        }
        ...
        for (var d = a.length; c < d; c++)
          for (var f in a[c])
            a[c].hasOwnProperty(f) &&
              b.push(f + "=" + ("undefined" == typeof a[c][f] ? "" : a[c][f]));
        wx.request({
  ...
  Event: {
    stat: function(a, b) {
      if ("" != MTA_CONFIG.event_id) {
        ...
        for (g in e)
          e.hasOwnProperty(g) &&
            k.push(encodeURIComponent(g) + "=" + encodeURIComponent(e[g]));
        e = k.join(";");
        f.r5 = e;
        e = 0;
